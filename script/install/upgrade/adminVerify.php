...
if(isset($_POST['submit'])) {
	...
	if(!$error) {
		...
		if(!validAdmin($username,$password)) {
			$error = "Invalid username or Password Can't Proceed";
		}
	}
}
$key = sha1(microtime());
...
<div class="panel-heading">
   <strong><i class="fa fa-gavel"></i> Admin Verification</strong>
    <div class="pull-right"><span class="badge badge-warning">Step 2</span>
    </div>
</div>  
